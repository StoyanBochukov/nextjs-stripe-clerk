import { getEventById } from '@/lib/serverActions/event.actions'
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl'>
            ...
            <div className='flex w-full flex-col gap-6 p-5 md:p-10'>
                ...
                <div className='flex flex-col gap-2'>
                    <p className='p-bold-20 text-grey-600'>Waht You'll Learn:</p>
                    <p className='p-medium-17 lg:p-regular-18'>{event.description}</p>
                    <p className='p-medium-17 lg:p-regular-18 truncate text-primary-500 underline'>{event.url}</p>
                </div>
            </div>
        </div>
    </section>
