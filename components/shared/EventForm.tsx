...
import { createEvent } from '@/lib/serverActions/event.actions';
 ...
 return (
  <Form {...form}>
   <form onSubmit={form.handleSubmit(onSubmit)} className='flex flex-col gap-5'>
        ...
        <FormControl>
         <div className='flex-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2'>
          ...
          <Input
           ...
           placeholder='Price'
           {...field}
           className='p-regular-16 border-0 bg-grey-50 outlane-offset-0
    ...
    <Button type='submit' size='lg' disabled={form.formState.isSubmitting} className='button col-span-2 w-fill'>
